...
const NCB_HeadingTagControl = (
  ...
  return useMemo( () => {
    ...
    const label = 'tag' === attribute
      ? _x( 'Set as heading %s', 'denhaag/paragraph: ToolbarButton label', 'nlds-community-blocks' )
      : _x( 'Show as heading %s', 'denhaag/paragraph: ToolbarButton label', 'nlds-community-blocks' );
    ...
    const controls = [
      ...
      .map( ( tagOption ) => <ToolbarButton
          onClick={ () => setAttributes( { [ attribute ]: tagOption.value } ) }
