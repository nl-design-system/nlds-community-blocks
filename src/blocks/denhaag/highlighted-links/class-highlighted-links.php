<?php
/**
 * Register the Highlighted_Links Block.
 *
 * Registers the Highlighted_Links Block for usage in the Gutenberg editor.
 *
 * @since      1.0.0
 *
 ...
 */
class Highlighted_Links extends Base_Block {
	/**
