    ...
    <>
      ...
      {!attributes.id && (
        <div className={_CLASSES.root}>
          ...
          <div>
            <strong>
              {_x( 'YouTube video URL or ID:', 'ncb-denhaag/embed-youtube: Title', 'ncb-community-blocks' )}
            </strong>
            <RichText
              tagName="div"
              ...
              value={attributes.id}
              onChange={(id) => setAttributes( {id: getYouTubeId( id )} )}
              allowedFormats={[]}
          ...
          <div>
            <strong>{
              _x( 'ScreenReader caption:', 'denhaag/embed-youtube: Title', 'ncb-community-blocks' )
            }</strong>
            <RichText
              tagName="div"
              className={_CLASSES.input}
        ...
        <>
          ...
          <details className={_CLASSES.details}>
            <summary className={_CLASSES.summary}>
              {_x( 'Option', 'denhaag/embed-youtube: Summary', 'ncb-community-blocks' )}
              <Chevron />
            </summary>
            <div className={_CLASSES.content}>
              <div>
                <strong>
                  {_x( 'YouTube video URL or ID:', 'denhaag/embed-youtube: Title', 'ncb-community-blocks' )}
                </strong>
                <RichText
                  tagName="div"
                  className={_CLASSES.input}
