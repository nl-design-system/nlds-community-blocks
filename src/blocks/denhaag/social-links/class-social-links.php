<?php
/**
 * Register the Social_Links Block.
 *
 * Registers the Social_Links Block for usage in the Gutenberg editor.
 *
 * @since      1.0.0
 *
 ...
 */
class Social_Links extends Base_Block {
	/**
