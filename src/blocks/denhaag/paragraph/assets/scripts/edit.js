...
export default function Edit( { attributes, setAttributes, mergeBlocks, clientId } ) {
	...
	const _PLACEHOLDER = attributes.placeholder ? attributes.placeholder : _x( 'Write paragraph…', 'ncb-denhaag/paragraph: Placeholder', 'nlds-community-blocks' );

	const allowedFormats = [ 'core/bold', 'core/italic', 'core/subscript', 'core/superscript' ];
  ...
  return (
		<>
			<BlockControls>
				<NCB_ParagraphVariationToolbarControl value={ attributes.variation } setAttributes={ setAttributes } />
			</BlockControls>
			<InspectorControls>
				<PanelBody title={ _x( 'Variation', 'ncb-denhaag/paragraph: Panel Title', 'nlds-community-blocks' ) }>
					<NCB_ParagraphVariationControl value={ attributes.variation } setAttributes={ setAttributes } />
				</PanelBody>
			</InspectorControls>
			<RichText
				identifier="content"
