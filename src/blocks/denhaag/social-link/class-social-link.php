<?php
/**
 * Register the Social_Link Block.
 *
 * Registers the Social_Link Block for usage in the Gutenberg editor.
 *
 * @since      1.0.0
 *
 * @package    Nlds_Community_Blocks
 * @subpackage Nlds_Community_Blocks/Src/Blocks/Denhaag/Social_Link
 */
 ...
 */
class Social_Link extends Base_Block {
	/**
