<?php
/**
 * Register the CTA_Download Block.
 *
 * Registers the CTA_Download Block for usage in the Gutenberg editor.
 *
 * @since      1.0.0
 *
 ...
 */
class CTA_Download extends Base_Block {
	/**
