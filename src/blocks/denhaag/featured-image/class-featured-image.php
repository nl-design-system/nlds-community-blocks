<?php
/**
 * Register the Featured_Image Block.
 *
 * Registers the Featured_Image Block for usage in the Gutenberg editor.
 *
 * @since      1.0.0
 *
 ...
 */
class Featured_Image extends Base_Block {
	/**
