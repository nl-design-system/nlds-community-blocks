 ...
 *
 * Registers the Divider Block for usage in the Gutenberg editor.
 *
 * @since      1.0.0
 *
 * @package    Nlds_Community_Blocks
 * @subpackage Nlds_Community_Blocks/Src/Blocks/Denhaag/Divider
 */
 ...
 */
class Divider extends Base_Block {
	/**
